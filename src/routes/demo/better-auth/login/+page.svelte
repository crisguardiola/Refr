...
<div class="relative flex min-h-svh flex-col items-center justify-center bg-white px-6 py-12">
	...
	<div class="mx-auto w-full max-w-sm space-y-8">
		...
		<div class="space-y-3">
			<Button
				variant="outline"
				class="h-11 w-full border-neutral-300 bg-white text-neutral-900 hover:bg-neutral-50 hover:text-neutral-900"
		...
		<div class="relative">
			...
			<div class="relative flex justify-center">
				<span class="bg-white px-2 text-sm text-neutral-500">or</span>
			</div>
		</div>
